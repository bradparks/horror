...
class Main extends Application {
	...
	public override function init (context:RenderContext):Void {
		...
		_loader.onComplete.add(onLoaded);
		_loader.load(new URLRequest("assets/lime.png"));
	}


	public function onLoaded(loader:URLLoader):Void {
		// just show image (dont convert, no time!)
